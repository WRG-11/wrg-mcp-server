...
(research_motor, wrg_governance (registry + checks), pulseboard.collectors.pulse_core,
wrg_memory, wrg_pipeline, release_check).
"""
...
from wrg_mcp_server.tools.prompts import register_status_prompts
